...
<!-- //Meta-Tags -->
<link href="<?php echo $this->webroot; ?>themeu/css/bootstrap.css" rel="stylesheet" type="text/css" media="all" /><!--bootstrap-css-->
<link href="<?php echo $this->webroot; ?>themeu/css/font-awesome.css" rel="stylesheet"> <!--font-awesome-css-->
<link rel="stylesheet" href="<?php echo $this->webroot; ?>themeu/css/flexslider.css" type="text/css" media="screen" /><!--flexslider-css-->
<link href="<?php echo $this->webroot; ?>themeu/css/circles.css" rel="stylesheet" type="text/css" media="all" /><!--skill-circles-->
<link href="<?php echo $this->webroot; ?>themeu/css/style.css" rel="stylesheet" type="text/css" media="all" /><!--style-sheet-->
<link href='<?php echo $this->webroot; ?>themeu/css/aos.css' rel='stylesheet prefetch' type="text/css" media="all" /><!--Animation-effects-css-->
<!--fonts-->
...
<div class="services-agileits" id="services">
	...
	<div class="tittle-agileinfo">
		...
		<img src="<?php echo $this->webroot; ?>themeu/images/services1.png" class="img-responsive" data-aos="slide-up" alt=""/>
		<div class="clearfix"> </div>
		</div>
	</div>
</div>
			...
			<div class="agile_team_grids">
				<div class="col-md-3 agile_team_grid" data-aos="zoom-in">
					<div class="view view-sixth">
						<img src="<?php echo $this->webroot; ?>themeu/images/t1.jpg" alt=" " class="img-responsive">
						<div class="mask">
							<h5>Agnese brent</h5>
				...
				<div class="col-md-3 agile_team_grid" data-aos="zoom-in">
					<div class="view view-sixth">
						<img src="<?php echo $this->webroot; ?>themeu/images/t2.jpg" alt=" " class="img-responsive">
						<div class="mask">
							<h5>Richard Walsh</h5>
							<p>Quis autem vel eum iure reprehenderit qui in ea voluptate velit.</p>
							<div class="w3l-social">
				...
				<div class="col-md-3 agile_team_grid" data-aos="zoom-in">
					<div class="view view-sixth">
						<img src="<?php echo $this->webroot; ?>themeu/images/t3.jpg" alt=" " class="img-responsive">
						<div class="mask">
							<h5>Lisa ortiz</h5>
							<p>Quis autem vel eum iure reprehenderit qui in ea voluptate velit.</p>
							<div class="w3l-social">
				...
				<div class="col-md-3 agile_team_grid" data-aos="zoom-in">
					<div class="view view-sixth">
						<img src="<?php echo $this->webroot; ?>themeu/images/t4.jpg" alt=" " class="img-responsive">
						<div class="mask">
							<h5>Scott flores</h5>
							<p>Quis autem vel eum iure reprehenderit qui in ea voluptate velit.</p>
							<div class="w3l-social">
			...
			<div class="gallery-grids-row">
				<div class="col-md-3 gallery-grid">
					<div class="wpf-demo-4">
						<a href="<?php echo $this->webroot; ?>themeu/images/g1.jpg" class="jzBoxLink item-hover" title="financial Business">
							<img src="<?php echo $this->webroot; ?>themeu/images/g1.jpg" alt=" " class="img-responsive" />
				...
				<div class="col-md-3 gallery-grid">
					<div class="wpf-demo-4">
						<a href="<?php echo $this->webroot; ?>themeu/images/g2.jpg" class="jzBoxLink item-hover" title="financial Business">
							<img src="<?php echo $this->webroot; ?>themeu/images/g2.jpg" alt=" " class="img-responsive" />
							<div class="view-caption">
								<p>Full View</p>
							</div>
						</a>
				...
				<div class="col-md-3 gallery-grid">
					<div class="wpf-demo-4">
						<a href="<?php echo $this->webroot; ?>themeu/images/g3.jpg" class="jzBoxLink item-hover" title="financial Business">
							<img src="<?php echo $this->webroot; ?>themeu/images/g3.jpg" alt=" " class="img-responsive" />
							<div class="view-caption">
								<p>Full View</p>
							</div>
						</a>
				...
				<div class="col-md-3 gallery-grid">
					<div class="wpf-demo-4">
						<a href="<?php echo $this->webroot; ?>themeu/images/g4.jpg" class="jzBoxLink item-hover" title="financial Business">
							<img src="<?php echo $this->webroot; ?>themeu/images/g4.jpg" alt=" " class="img-responsive" />
							<div class="view-caption">
								<p>Full View</p>
							</div>
						</a>
				...
				<div class="col-md-3 gallery-grid">
					<div class="wpf-demo-4">
						<a href="<?php echo $this->webroot; ?>themeu/images/g5.jpg" class="jzBoxLink item-hover" title="financial Business">
							<img src="<?php echo $this->webroot; ?>themeu/images/g5.jpg" alt=" " class="img-responsive" />
							<div class="view-caption">
								<p>Full View</p>
							</div>
						</a>
				...
				<div class="col-md-3 gallery-grid">
					<div class="wpf-demo-4">
						<a href="<?php echo $this->webroot; ?>themeu/images/g6.jpg" class="jzBoxLink item-hover" title="financial Business">
							<img src="<?php echo $this->webroot; ?>themeu/images/g6.jpg" alt=" " class="img-responsive" />
							<div class="view-caption">
								<p>Full View</p>
							</div>
						</a>
				...
				<div class="col-md-3 gallery-grid">
					<div class="wpf-demo-4">
						<a href="<?php echo $this->webroot; ?>themeu/images/g7.jpg" class="jzBoxLink item-hover" title="financial Business">
							<img src="<?php echo $this->webroot; ?>themeu/images/g7.jpg" alt=" " class="img-responsive" />
							<div class="view-caption">
								<p>Full View</p>
							</div>
						</a>
				...
				<div class="col-md-3 gallery-grid">
					<div class="wpf-demo-4">
						<a href="<?php echo $this->webroot; ?>themeu/images/g8.jpg" class="jzBoxLink item-hover" title="financial Business">
							<img src="<?php echo $this->webroot; ?>themeu/images/g8.jpg" alt=" " class="img-responsive" />
							<div class="view-caption">
								<p>Full View</p>
							</div>
						</a>
					...
					<div class="strip">
						<div class="slide sticky">
							<div class="col-md-6 agileinfo_team_grid" data-aos="zoom-in">
								<div class="agileinfo_team_grid1">
									...
									<img src="<?php echo $this->webroot; ?>themeu/images/t1.jpg" alt="" />
							...
							<div class="col-md-6 agileinfo_team_grid" data-aos="zoom-in">
								<div class="agileinfo_team_grid1">
									<div class="test-top-wthree">
									<img src="<?php echo $this->webroot; ?>themeu/images/t2.jpg" alt="" />
										<div class="test-right-wthree">
											<h6>Liza Brent</h6>
											<p>Lorem ipsum dolor sit amet, </p>
										</div>
						...
						<div class="slide">
							<div class="col-md-6 agileinfo_team_grid" data-aos="zoom-in">
								<div class="agileinfo_team_grid1">
									<div class="test-top-wthree">
									<img src="<?php echo $this->webroot; ?>themeu/images/t3.jpg" alt="" />
										<div class="test-right-wthree">
											<h6>Leslie gross</h6>
											<p>Lorem ipsum dolor sit amet, </p>
										</div>
							...
							<div class="col-md-6 agileinfo_team_grid" data-aos="zoom-in">
								<div class="agileinfo_team_grid1">
									<div class="test-top-wthree">
									<img src="<?php echo $this->webroot; ?>themeu/images/t4.jpg" alt="" />
										<div class="test-right-wthree">
...
<!-- js -->
<script type="text/javascript" src="<?php echo $this->webroot; ?>themeu/js/jquery-2.1.4.min.js"></script>
<!--search-bar-->
		<script src="<?php echo $this->webroot; ?>themeu/js/main.js"></script>
<!--//search-bar-->
<!-- FlexSlider -->
				  <script defer src="<?php echo $this->webroot; ?>themeu/js/jquery.flexslider.js"></script>
				  <script type="text/javascript">
					$(function(){
					});
...
<!-- clients-slider-script -->
				<script src="<?php echo $this->webroot; ?>themeu/js/slideshow.min.js"></script>
				<script src="<?php echo $this->webroot; ?>themeu/js/launcher.js"></script>
<!-- //clients-slider-script -->
<!-- /circle-->
	 <script type="text/javascript" src="<?php echo $this->webroot; ?>themeu/js/circles.js"></script>
					         <script>
								var colors = [
...
<!-- //for-Map -->
<script src="<?php echo $this->webroot; ?>themeu/js/jzBox.js"></script>
<!-- start-smoth-scrolling -->
<script type="text/javascript" src="<?php echo $this->webroot; ?>themeu/js/move-top.js"></script>
<script type="text/javascript" src="<?php echo $this->webroot; ?>themeu/js/easing.js"></script>
<script type="text/javascript">
...
<!-- Animation-effect -->
<script src='<?php echo $this->webroot; ?>themeu/js/aos.js'></script>
<script src="<?php echo $this->webroot; ?>themeu/js/aosindex.js"></script>
<!-- //Animation-effect -->
	<a href="#home" class="scroll" id="toTop" style="display: block;"> <span id="toTopHover" style="opacity: 1;"> </span></a>
<!-- //smooth scrolling -->
<script src="<?php echo $this->webroot; ?>themeu/js/bootstrap.js"></script>
