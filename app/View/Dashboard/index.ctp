  ...
  <div class="main-page">
    ...
    <div class="row">
      <div class="col-md-8 map widget-shadow">
        ...
        <!--map js-->
        <link href="<?php echo $this->webroot; ?>theme/css/jqvmap.css" rel='stylesheet' type='text/css' />
        <script src="<?php echo $this->webroot; ?>theme/js/jquery.vmap.js"></script>
        <script src="<?php echo $this->webroot; ?>theme/js/jquery.vmap.sampledata.js" type="text/javascript"></script>
        <script src="<?php echo $this->webroot; ?>theme/js/jquery.vmap.world.js" type="text/javascript"></script>
